...
Simulate attacker techniques using Atomic Red Team

Generate endpoint telemetry using Sysmon and Windows Event Logs

Ingest logs into SIEM platforms

Develop detection queries using KQL (Sentinel) and SPL (Splunk)
...
If you'd like, I can also show you one section almost every high-end security GitHub project includes that yours is missing (it’s the difference between a good project and a “this person is hireable” project).
